...
class IntelligentTavilyAutomation:
    ...
    def start_browser(self, headless=None):
        ...
        if BROWSER_TYPE == "firefox":
            ...
            self.browser = self.playwright.chromium.launch(
                headless=headless_mode, args=browser_args
            )
        ...
        try:
            ...
            self.log(
                "⚠️ playwright-stealth 未安装，跳过反检测（pip install playwright-stealth）"
            )
    ...
    def navigate_to_signup(self):
        ...
        try:
            ...
            self.page.goto(
                TAVILY_HOME_URL, wait_until="domcontentloaded", timeout=60000
            )
            try:
                self.page.wait_for_load_state("networkidle", timeout=10000)
            except:
            ...
            if self.smart_click("signup_button"):
                ...
                self.page.goto(
                    TAVILY_SIGNUP_URL, wait_until="domcontentloaded", timeout=60000
                )
                try:
                    self.page.wait_for_load_state("networkidle", timeout=10000)
                except:
    ...
    def fill_password(self):
        ...
        try:
            ...
            element, selector = self.smart_wait_for_element(
                element_config, timeout=5000
            )
                ...
                try:
                    ...
                    if btn:
                        ...
                        api_key_match = re.search(
                            r"tvly-[A-Za-z0-9\-_]{20,}", page_text
                        )
                        if api_key_match:
                            return api_key_match.group(0)
                except:
